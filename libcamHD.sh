...
libcamera-vid -t 0 --width 1920 --height 1080 --codec yuv420 --framerate 25 --inline --listen -o - --verbose=0| cvlc --no-hotkeys --no-global-keybindings -vvv stream:///dev/stdin --sout '#transcode{vcodec=h264,vb=800,scale=Auto,acodec=none}:rtp{sdp=rtsp://192.168.137.199:8554/}' --demux=rawvideo --rawvid-fps=25 --rawvid-width=1920 --rawvid-height=1080 --rawvid-chroma=I420
